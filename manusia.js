...
const client = makeWASocket({ logger: pino ({ level: 'silent' }), printQRInTerminal: true, auth: state, browser: ["SC Simple By PutuOfc", "Dekstop", "3.0"]})
console.log(color('[ NAMA : PUTU ]\n', 'red'),color('\nInfo orangnya :\n➸ Nama  : Putu\n➸ Hoby : Mandangin Dia\n➸ Status : Penyendiri\n\nFollow My Social Media :\n➸ My Whatsapp : 6289630567696\n➸ My Youtube : PutuOfc\n➸ My Instagram : @putuofc_\n', 'green'))
